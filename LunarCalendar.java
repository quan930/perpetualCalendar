...
public class LunarCalendar {
    ...
    public void currentMonth(Calendar calendar){
 		...
 		//当前月份第一天的星期
 		try {
			calendar.setTime(chineseDateFormat.parse(chineseDateFormat.format(calendar.getTime())));
		} catch (ParseException e) {
    ...
    //当日日历
    public void todayCalendar() throws ParseException {
    		Calendar today = Calendar.getInstance();
	 	today.setTime(chineseDateFormat.parse(chineseDateFormat.format(today.getTime())));  
        LunarCalendar lunarDay = new LunarCalendar(today);
        System.out.println("日期： 阳历 " + chineseDateFormat.format(today.getTime()) + "　农历 " +lunarDay.animalsYear()+" "+lunarDay.cyclical()+"年 "+lunarDay.toString());
